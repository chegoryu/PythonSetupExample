...
Первый это `name`, задающий общее имя нашего приложения. На него наложены некоторые ограничения, а именно, `name` должн состоять только из английских букв, цифр, символов `_`, `-`.
